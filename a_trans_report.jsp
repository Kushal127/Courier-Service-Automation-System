<%@ page language="java" import="java.sql.*,java.util.*" errorPage="" %>
<%@ page import="courier.*"%>
<html>
<head>
...
<%!String ddate;%>
<%
String ddate=request.getParameter("odate");
System.out.println("ddate is ========================"+ddate);
ResultSet rs=st1.executeQuery("select * from transaction where odate='"+ddate+"'");
%>
<table border="1">
